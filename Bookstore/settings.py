...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_PATH', BASE_DIR / 'bookstore.db'),
    }
}
...
AUTH_USER_MODEL = "api.BookstoreUser"

# Hide Django login button on swagger UI
SWAGGER_SETTINGS = {
    'USE_SESSION_AUTH': False
}

# Config storage for uploading images
